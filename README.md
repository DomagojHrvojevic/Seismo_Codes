...
<ins>**Scripts:**</ins>
  ...
  * `HDF5_data_analysis.py:` Python code for analysis of HDF5 data files recorded by FEBUS DAS instrument. Using h5py [^5] library for plotting StrainRate data and making them in gif with imageio [^6] library (figure 3).
...
[^3]: [xml2resp - will read an input file in station.xml format and write the equivalent response data in RESP format](https://github.com/EarthScope/evalresp/blob/main/doc/xml2resp.1)
[^4]: [DASPy    - open-source project that provides a python package for DAS (Distributed Acoustic Sensing) data processing](https://daspy-tutorial.readthedocs.io/en/latest/index.html)
[^5]: [HDF5 - a container for two kinds of objects: datasets (array-like data) and groups (folder-like containers)](https://docs.h5py.org/en/latest/quick.html)
[^6]: [Imageio - Python library for reading and writing a wide range of image data, animated images, volumetric data, and scientific formats](https://pypi.org/project/imageio/)
[^7]: [mailx - an intelligent mail processing system](https://manpages.ubuntu.com/manpages/xenial/man1/bsd-mailx.1.html)
[^8]: [SQLite - a C library that provides a lightweight disk-based database](https://docs.python.org/3/library/sqlite3.html)
[^9]: [pandas - a Python package that provides fast, flexible, and expressive data structures designed for working with "relational" or "labeled" data](https://pypi.org/project/pandas/)
[^10]: [Folium - builds on the data wrangling strengths of the Python ecosystem and the mapping strengths of the Leaflet.js library](https://python-visualization.github.io/folium/latest/)
[^11]: [GeoPandas - an open source project to make working with geospatial data in python easier](https://geopandas.org/en/stable/)
[^12]: [contextily - a small Python 3 package to retrieve tile maps from the internet](https://contextily.readthedocs.io/en/latest/)
