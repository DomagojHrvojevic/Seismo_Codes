...
"""
    Description:    Formatting seismological data gathered by Smartsolo portable seismograph for SANDI software usage.
                    ...
                    This code is modificated and refined from /home/DuFAULT/DATA/data_modules.py
    ...
    Remark:         Working with miniconda ispaq environment.
                    ...
                    In the text file, the ID parameter for each station corresponds to the name of the folder containing the mseed data for that station.
                    ...
                    data_path_static ->             path to folder containing folders of smartsolo stations
...
data_path_static = '/mnt/d/smartsolo_data/Paklenica-NET'
...
for i_d in stations_csv['ID']:#[5:6]:
    ...
    data_path_dynamic = data_path_static + f'/{location_name}/{i_d}'
